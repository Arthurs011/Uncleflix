    ...
    <div className="min-h-screen px-4 md:px-8 pt-6 pb-16">
      ...
      <div className="flex items-center gap-4 mb-8">
        <Link
          ...
          className="w-9 h-9 rounded-full bg-secondary/80 hover:bg-accent/30 border border-accent/20 flex items-center justify-center transition-all"
        >
          <ArrowLeft size={18} />
        </Link>
        <div>
          ...
          <h1 className="text-2xl md:text-3xl font-black text-white">{genreName}</h1>
        </div>
      </div>
          ...
          {hasMore && (
            <div className="flex justify-center mt-10">
              <button
                ...
                className="flex items-center gap-2 px-8 py-3 bg-secondary/80 hover:bg-accent/20 border border-accent/30 rounded-full text-sm font-semibold text-white transition-all disabled:opacity-50"
              >
                {loadingMore ? (
